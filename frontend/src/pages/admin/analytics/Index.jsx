...
const COLORS = ['#8B6F5A', '#C4957A', '#D4C0B8'];
            ...
            <div className="h-72">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={revenueData}>
                  ...
                  <CartesianGrid strokeDasharray="3 3" stroke="#D4C0B8" opacity={0.5} />
                  ...
                  <Tooltip contentStyle={{ borderRadius: 12, border: '1px solid #D4C0B8', background: '#fff' }} />
                  <Area type="monotone" dataKey="revenue" stroke="#8B6F5A" strokeWidth={2} fill="url(#rev)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </AdminCard>
            ...
            <div className="h-72">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={userGrowthData}>
                  ...
                  <YAxis tick={{ fontSize: 11, fill: '#5C4A45' }} axisLine={false} tickLine={false} />
                  <Tooltip contentStyle={{ borderRadius: 12, border: '1px solid #D4C0B8', background: '#fff' }} />
                  <Bar dataKey="users" fill="#C4957A" radius={[4, 4, 0, 0]} barSize={20} />
                  <Bar dataKey="active" fill="#8B6F5A" radius={[4, 4, 0, 0]} barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </AdminCard>
            ...
            <div className="h-72">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={conversionData}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#D4C0B8" opacity={0.5} />
                  <XAxis dataKey="name" tick={{ fontSize: 11, fill: '#5C4A45' }} axisLine={false} tickLine={false} />
                  <YAxis tick={{ fontSize: 11, fill: '#5C4A45' }} axisLine={false} tickLine={false} unit="%" />
                  <Tooltip contentStyle={{ borderRadius: 12, border: '1px solid #D4C0B8', background: '#fff' }} />
                  <Line type="monotone" dataKey="rate" stroke="#8B6F5A" strokeWidth={2} dot={{ fill: '#8B6F5A', r: 4 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </AdminCard>
