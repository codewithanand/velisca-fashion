            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={monthlyData}>
                  ...
                  <CartesianGrid strokeDasharray="3 3" stroke="#EADCD6" strokeOpacity={0.5} />
                  ...
                  <Tooltip
                    contentStyle={{ borderRadius: 12, border: '1px solid #EADCD6', background: '#fff', boxShadow: '0 4px 12px rgba(0,0,0,0.08)' }}
                  />
                  <Area type="monotone" dataKey="revenue" stroke="#B08968" strokeWidth={2} fill="url(#revenueGrad)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </AdminCard>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={monthlyData}>
                  ...
                  <YAxis tick={{ fontSize: 11, fill: '#7B6A65' }} axisLine={false} tickLine={false} />
                  <Tooltip
                    contentStyle={{ borderRadius: 12, border: '1px solid #EADCD6', background: '#fff' }}
                  />
                  <Bar dataKey="orders" fill="#D8B4A0" radius={[4, 4, 0, 0]} barSize={20} />
                  <Bar dataKey="users" fill="#B08968" radius={[4, 4, 0, 0]} barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </AdminCard>
